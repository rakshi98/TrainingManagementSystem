...
<head>
    ...
    <!-- Bootstrap 3.3.2 JS -->
    <script src="https://phpdatagrid.com/laravel5-bootstrap3/public/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
    <!-- AdminLTE App -->
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="https://image.flaticon.com/icons/png/512/17/17004.png " class="img-circle" alt="User Image">
            </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="Admin_profile.jsp"><i class="fa fa-link"></i> <span>Profile</span></a></li>
               ...
               <li class="treeview">
<a href="#"><i class="fa fa-link"></i> <span>Training</span> <i class="fa fa-angle-left pull-right"></i></a>
             ...
             <li><a href="Admin_viewfeedback.jsp"><i class="fa fa-link"></i> <span>ViewFeedback</span>
              <li><a href="Admin_viewnominations.jsp"><i class="fa fa-link"></i> <span>View Nomination</span></a></li>
...
<table id="myTable">
  <tr class="header">
    ...
    <th style="width:40; font-weight:bold;">EId</th>
	<th style="width:40;font-weight:bold;">TrainingId</th>
	<th style="width:40;font-weight:bold;">Comments</th>
  </tr>
<% 
while(rs.next())
{
