...
<body class="skin-blue sidebar-mini sidebar-collapse">
 ...
 -->
							<div class="card-body">
								...
								<form onsubmit="return validform()" action="feed" method="post">
									...
									<div class="form-group row">
										<label for="eid" class="col-md-4 col-form-label text-md-right">EId</label>
										<div class="col-md-6">
											<input type="text" id="eid" class="form-control" name="eid">
										</div>
									</div>

									<div class="form-group row">
										<label for="trainingid"
											class="col-md-4 col-form-label text-md-right">trainingId</label>
										<div class="col-md-6">
